...
class FormDocument extends Component
{
    ...
    {
        return view('livewire.form-document');
    }
    ...
    public function downloadPDF(){
        ...
        $data = [
            ...
            'notario_propiedad'        => $this->notario_propiedad,
            'notaria_numero_propiedad' => $this->notaria_numero_propiedad,
            'no_escritura_propiedad'   => $this->no_escritura_propiedad,
            'fecha_escritura_propiedad'=> $this->fecha_escritura_propiedad,
            'registro_numero'          => $this->registro_numero,
            'tomo_numero'              => $this->tomo_numero,
            'cuenta_predial'           => $this->cuenta_predial,
            'recibo_pago_predial'      => $this->recibo_pago_predial,
            'referencia_pago'          => $this->referencia_pago,
            'fecha_pago'               => $this->fecha_pago,
            'notario_constitutiva'        => $this->notario_constitutiva,
            'notaria_numero_constitutiva' => $this->notaria_numero_constitutiva,
            'no_escritura_constitutiva'   => $this->no_escritura_constitutiva,
            'fecha_escritura_constitutiva'=> $this->fecha_escritura_constitutiva,
            'folio_mercantil'             => $this->folio_mercantil,

        ];
        $pdf = PDF::loadView('livewire.form-visualization',$data);
