                        ...
                        <div>
                            ...
                            <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 py-6">
                                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                                    <h1 class="text-2xl font-semibold mb-4">Agregar Apoderado Legal para {{ $empresa->nombre }}</h1>
                                    ...
                                    <form action="{{ route('apoderados.store', ['empresa' => $empresa->id]) }}" method="POST">
                                        @csrf
                                        ...
                                        <div class="grid grid-cols-2 gap-4">
                                            ...
                                            <div>
                                                ...
                                                <input type="text" name="prefijo" value="{{ old('prefijo') }}" placeholder="Ej: Sr., Dra., Lic." 
                                                    class="w-full px-4 py-2 border rounded-md focus:ring focus:ring-blue-300">
                                            </div>

                                            <div>
                                                <label class="block font-medium text-gray-700">Título</label>
                                                <input type="text" name="titulo" value="{{ old('titulo') }}" placeholder="Ej: Abogado, Contador" 
                                                    class="w-full px-4 py-2 border rounded-md focus:ring focus:ring-blue-300">
                                            </div>
                                            ...
                                            <div class="col-span-2">
                                                ...
                                                <textarea name="direccion" rows="3" class="w-full px-4 py-2 border rounded-md focus:ring focus:ring-blue-300">{{ old('direccion') }}</textarea>
                                            </div>
                                        </div>
